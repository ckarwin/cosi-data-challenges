...
The tools that were used for the simulations (including the source library, orientation file, transmission probability file, etc.) are available in the main branch of cositools/cosi-sim ([link](https://github.com/cositools/cosi-sim)). 
